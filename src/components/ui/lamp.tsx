        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-16 max-w-7xl mx-auto md:px-8 w-full">
          <WobbleCard containerClassName="col-span-1">
            ...
            <p className="mt-4  text-left  text-base/6 text-neutral-200">
              ...
              results in positive-sum outcomes and externalities in Rwanda
              through Ethereum.
            </p>
          </WobbleCard>
          <WobbleCard containerClassName="col-span-1">
...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-slate-950 w-full rounded-md z-0",
        className
      )}
    >
      <div className="relative w-full flex-1 flex items-center justify-center isolate z-0">
        <motion.div
      ...
      <div className="relative w-full max-w-7xl mx-auto py-16 px-5 md:py-24 lg:py-32">
        {children}
      </div>
    </div>
  );
